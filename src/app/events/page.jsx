            ...
            <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl font-extrabold text-[#1e3a8a] mb-4">Events & Schedule</h1>
                    ...
                    <section className="mb-16">
                        <h2 className="text-2xl font-bold text-[#1e3a8a] mb-6 flex items-center gap-2">
                            <Calendar className="text-[#1e3a8a]" /> Upcoming Events
                        </h2>
                        {upcomingEvents.length > 0 ? (
                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                {upcomingEvents.map((event) => (
                                    <div key={event._id} className="bg-white rounded-xl shadow-lg overflow-hidden border-t-4 border-[#1e3a8a] hover:shadow-xl transition-shadow">
                                        <div className="p-6">
                                            <div className="flex items-center text-sm text-gray-500 mb-4">
                                                <span className="bg-orange-100 text-blue-800 px-3 py-1 rounded-full font-medium">
