        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-extrabold text-[#ff9933] mb-4">Media & Press Center</h1>
                ...
                {photos.length > 0 && (
                    <section className="mb-16">
                        <h2 className="text-2xl font-bold text-[#000080] mb-6 flex items-center gap-2">
                            <Image className="text-[#ff9933]" /> Photo Gallery
                        </h2>
                ...
                {videos.length > 0 && (
                    <section className="mb-16">
                        <h2 className="text-2xl font-bold text-[#000080] mb-6 flex items-center gap-2">
                            <Video className="text-[#ff9933]" /> Video Gallery
                        </h2>
                ...
                {news.length > 0 && (
                    <section>
                        <h2 className="text-2xl font-bold text-[#000080] mb-6 flex items-center gap-2">
                            <Newspaper className="text-[#ff9933]" /> In The News
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {news.map((item) => (
                                <div key={item._id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow border border-gray-100">
                                    ...
                                    <div className="p-4">
                                        <span className="text-xs font-medium text-[#ff9933] uppercase tracking-wider">Press Release</span>
